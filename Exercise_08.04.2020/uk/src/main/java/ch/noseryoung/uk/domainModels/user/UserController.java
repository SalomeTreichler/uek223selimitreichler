...
public class UserController {
    ...
    @GetMapping("")
    public ResponseEntity<List<UserDTO>> getUsersWithTheNameGarfield(){
        return new ResponseEntity<>(userMapper.toDTOs(userService.findUsersWithTheNameGarfield()),HttpStatus.OK);
    }
